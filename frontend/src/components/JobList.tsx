                ...
                <div className="flex justify-between items-center">
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex items-center gap-2 bg-white hover:bg-blue-50 text-blue-600 hover:text-blue-700 px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium hover:shadow-md transform hover:scale-105"
                    >
                    ...
                    {user?.role === 'hr' && (
                      <button
                        ...
                        className="flex items-center gap-2 bg-white hover:bg-green-50 text-green-600 hover:text-green-700 px-4 py-2 rounded-lg transition-all duration-200 text-sm font-medium hover:shadow-md transform hover:scale-105"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {user?.role === 'hr' && (
                    <button
                      ...
                      className="flex items-center gap-2 text-red-600 hover:text-red-800 hover:bg-red-50 p-2 rounded-lg transition-colors disabled:opacity-50"
                      title="Delete job"
                    >
